...
class Oregonator_2():
    ...
    def __init__(self, t_max, X1, Y1, Y2, Y3, rho1, rho2, type_index):
        ...
        self.c1 = self.rho1 / (self.Y2 * self.X1)
        ...
        # alpha1 = h1 * c1 = X1 * Y2 * c1
        self.alpha1 = self.c1 * self.X1 * self.Y2
    ...
    def KMC_direct_method(self):
        ...
        return Y1_molecule, Y2_molecule, Y3_molecule, X1_molecule, t_series
    ...
    def plot(self):
        ...
        if self.type_index == 1:
            ...
            Y1_molecule, Y2_molecule, Y3_molecule, X1_molecule, t_series = self.KMC_direct_method()

            graph_title = 'direct method'

            savefig_title = 'Oreganator2_direct method'
        else:
            Y1_molecule, Y2_molecule, Y3_molecule, X1_molecule, t_series = self.KMC_first_reaction_method()
            graph_title = 'first-reaction method'

            savefig_title = 'Oreganator2_first-reaction method'
...
def main_direct_method():
    ...
    Oregonator2 = Oregonator_2(6, 10000, 500, 1000, 2000, 2000, 50000, 1)
...
def main_first_reaction_method():
    ...
    Oregonator2 = Oregonator_2(6, 10000, 500, 1000, 2000, 2000, 50000, 2)
